...
- The Flyff client's Monster-Stats HUD provides only a single global kill count ([US-030](completed/US-030-monster-stats-hud-ocr-diagnostics-and-debug-panel.md), [US-034](completed/US-034-background-independent-monster-stats-kill-confirmation.md)), without breaking down kills by monster class.
...
- [ ] **Interactive Multi-Mob Selection UI:**
...
- [ ] **Internal Per-Mob Kill Tracking & Persistence:**
...
- [ ] **Session Completion & Client Shutdown:**
