...
- The current desktop UI ([US-010](US-010-pyside6-dashboard-and-overlay.md), [US-020](US-020-visual-navigation-path-and-heatmap-inspector.md), [US-021](US-021-navigation-map-profiles-and-session-reset.md)) uses default unstyled Qt widgets ("bare metal"), resulting in an uncohesive appearance and vertical crowding when the map inspector is active.
...
- [x] **Card-based layout & reduced text clutter:**
...
- [x] **Pop-out navigation map window:**
