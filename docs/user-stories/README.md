...
- [ ] [**US-019: Intelligent pathing and topological spawn heatmap for monster farming**](US-019-intelligent-pathing-and-spawn-heatmap.md) — Internal spatial memory, spawn heatmaps, stuck cost penalties, and adaptive patrol circuits.
