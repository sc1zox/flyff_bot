...
- [ ] [**US-042: Automated camera alignment and standardized viewport initialization**](US-042-automated-camera-alignment-and-standardized-viewport-initialization.md) — Deterministic pre-flight and on-demand camera alignment routine setting zoom hard-stop and ~45° pitch so perception distance models match live farming.
