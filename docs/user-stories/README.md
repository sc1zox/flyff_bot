...
- [ ] [**US-084: ML-modifiable tactical parameter space, hybrid tuning, and clamped safety bounds**](US-084-ml-modifiable-tactical-parameters-and-tuning.md) — Typed parameter space encapsulating tactical navigation, combat, perception, and recovery constants, hybrid offline optimization and contextual live policy overrides, deterministic safety clamping, and profile persistence.
