...
- [ ] [**US-076: Complete fingerprinted client player stats reader**](US-076-complete-client-player-stats-reader.md) — Read every verifiable player statistic through exact SHA-256 read-only profiles and remove player-stats OCR as an automation input.
