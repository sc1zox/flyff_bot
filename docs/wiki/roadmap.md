...
### Phase 3: Closed-Loop Execution & Reactive Controllers (Active)
...
- **US-013:** Autonomous farming loop and orchestration engine (Unified closed-loop session coordinating perception, combat, looting, and recovery).
