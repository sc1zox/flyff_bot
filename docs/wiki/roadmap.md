...
- **US-003:** Mob detection with YOLO and OpenCV (Dynamic entity detection and bounding boxes).
- **US-004:** Target mob verification and inspection (Target-bar ROI extraction, name matching, HP bar inspection).
