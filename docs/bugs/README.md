...
- [ ] [**BUG-041: Camera alignment fails closed with top-down pitch inversion and non-functional zoom-out**](BUG-041-camera-alignment-pitch-sign-inversion-and-zoom-early-termination.md)
