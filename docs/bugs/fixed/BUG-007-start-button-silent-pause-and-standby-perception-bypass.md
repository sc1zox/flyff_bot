...
Per [US-010](../../user-stories/completed/US-010-pyside6-dashboard-and-overlay.md), [US-013](../../user-stories/completed/US-013-autonomous-farming-loop-and-orchestration-engine.md), and [US-028](../../user-stories/completed/US-028-live-perception-standby-and-focus-workflow.md):
...
- [x] Automated tests in `tests/unit/test_orchestrator.py` verifying standby perception execution and status publishing without input dispatch.
- [x] Automated tests in `tests/unit/test_ui.py` verifying status badge separation and window state indications.
- [x] The checks pass after implementing [US-028](../../user-stories/completed/US-028-live-perception-standby-and-focus-workflow.md).
