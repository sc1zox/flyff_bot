"""Tests for the standardized camera zoom and pitch alignment routine (US-042)."""
...
def _aligner(adapter: _CameraAdapter, sleeps: list[float]) -> CameraAligner:
    return CameraAligner(adapter, WINDOW_HANDLE, sleep=sleeps.append)
